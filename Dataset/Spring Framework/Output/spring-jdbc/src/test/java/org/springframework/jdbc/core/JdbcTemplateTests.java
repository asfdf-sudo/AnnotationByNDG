...
class JdbcTemplateTests {
	...
	private void doTestStrings( @Nullable Integer fetchSize,  @Nullable Integer maxRows,  @Nullable Integer queryTimeout,
			 @Nullable Object argument,  @Nullable JdbcTemplateCallback jdbcTemplateCallback) throws Exception {
