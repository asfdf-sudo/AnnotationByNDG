...
public abstract class JdbcUtils {
	 ...
	 */
	 @Nullable public static Object getResultSetValue( @Nullable ResultSet rs, int index) throws SQLException {
		Object obj = rs.getObject(index);
	 ...
	 */
	public static <T extends Object> T extractDatabaseMetaData(DataSource dataSource, DatabaseMetaDataCallback<T> action)
