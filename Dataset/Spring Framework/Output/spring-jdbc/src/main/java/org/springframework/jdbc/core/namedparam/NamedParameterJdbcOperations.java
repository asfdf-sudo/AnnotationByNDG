...
public interface NamedParameterJdbcOperations {
	 ...
	 */
	<T extends Object> T execute(String sql, SqlParameterSource paramSource, PreparedStatementCallback<T> action)
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T execute(String sql, Map<String, ?> paramMap, PreparedStatementCallback<T> action)
			throws DataAccessException;
	 ...
	 */
	<T extends Object> T query(String sql, SqlParameterSource paramSource, ResultSetExtractor<T> rse)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> T query(String sql, Map<String, ?> paramMap, ResultSetExtractor<T> rse)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> List<T> query(String sql, SqlParameterSource paramSource, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> List<T> query(String sql, Map<String, ?> paramMap, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @since 5.3
	 */
	<T extends Object> Stream<T> queryForStream(String sql, SqlParameterSource paramSource, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @since 5.3
	 */
	<T extends Object> Stream<T> queryForStream(String sql, Map<String, ?> paramMap, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> T queryForObject(String sql, SqlParameterSource paramSource, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> T queryForObject(String sql, Map<String, ?> paramMap, RowMapper<T> rowMapper)
			throws DataAccessException;
