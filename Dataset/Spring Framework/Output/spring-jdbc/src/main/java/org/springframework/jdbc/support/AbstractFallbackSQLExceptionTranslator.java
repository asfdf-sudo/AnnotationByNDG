...
public abstract class AbstractFallbackSQLExceptionTranslator implements SQLExceptionTranslator {
	 ...
	 * @since 6.1
	 */
	public void setCustomTranslator(SQLExceptionTranslator customTranslator) {
	 ...
	 */
		 @Nullable public DataAccessException translate(String task, String sql, SQLException ex) {
