...
public abstract class ScriptUtils {
	...
	private static String readScript(LineNumberReader lineNumberReader,  @Nullable String [] commentPrefixes,
			String separator,  @Nullable String blockCommentEndDelimiter) throws IOException {
	...
	private static boolean startsWithAny(String script,  @Nullable String[] prefixes, int offset) {
