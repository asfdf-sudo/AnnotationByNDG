...
public abstract class DataSourceUtils {
	 ...
	 */
	 @Nullable static Integer prepareConnectionForTransaction( @Nullable Connection con, int isolationLevel, boolean setReadOnly)
			throws SQLException {
	 ...
	 */
	public static boolean isConnectionTransactional( @Nullable Connection con,  @Nullable DataSource dataSource) {
		if (dataSource == null) {
			return false;
		}
		ConnectionHolder conHolder = (ConnectionHolder) TransactionSynchronizationManager.getResource(dataSource);
	 ...
	 */
	public static Connection getTargetConnection( @Nullable Connection con) {
	 ...
	 */
	private static int getConnectionSynchronizationOrder( @Nullable DataSource dataSource) {
