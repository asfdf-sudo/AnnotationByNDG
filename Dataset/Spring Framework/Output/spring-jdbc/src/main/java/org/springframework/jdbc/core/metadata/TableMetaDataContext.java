...
public class TableMetaDataContext {
	 ...
	 */
	 @Nullable public List<Object> matchInParameterValuesWithInsertColumns(SqlParameterSource parameterSource) {
	 ...
	 */
	 @Nullable public List<Object> matchInParameterValuesWithInsertColumns( @Nullable Map<String, ?> inParameters) {
	...
	private static final class QuoteHandler {
		...
		QuoteHandler(String identifierQuoteString) {
			this.identifierQuoteString = identifierQuoteString;
			this.quoting = StringUtils.hasText(identifierQuoteString);
		}

		void appendTo(StringBuilder stringBuilder, String item) {
			if (this.quoting) {
