...
public class SQLErrorCodeSQLExceptionTranslator extends AbstractFallbackSQLExceptionTranslator {
	...
	public SQLErrorCodes getSqlErrorCodes() {
		return SupplierUtils.resolve(this.sqlErrorCodes);
			 ...
			 @Nullable protected DataAccessException doTranslate(String task, String sql, SQLException ex) {
	 ...
	 */
		 @Nullable protected DataAccessException customTranslate( @Nullable String task,  @Nullable String sql,  @Nullable SQLException sqlEx) {
		return null;
	}
	 ...
	 */
	 @Nullable protected DataAccessException createCustomException(
			 @Nullable String task,  @Nullable String sql,  @Nullable SQLException sqlEx, Class<?> exceptionClass) {
