...
abstract class DatabasePopulatorConfigUtils {
	...
	public static void setDatabasePopulator(Element element, BeanDefinitionBuilder builder) {
	 ...
	 @Nullable private static BeanDefinition createDatabasePopulator(Element element, List<Element> scripts, String execution) {
	 ...
	 @Nullable private static String getSeparator(Element element, Element scriptElement) {
