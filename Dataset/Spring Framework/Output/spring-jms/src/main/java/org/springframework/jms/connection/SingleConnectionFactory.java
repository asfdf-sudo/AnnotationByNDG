...
public class SingleConnectionFactory implements ConnectionFactory, QueueConnectionFactory,
	 ...
	 */
		...
		public Connection createConnection( @Nullable String username,  @Nullable String password) throws JMSException {
		...
		public QueueConnection createQueueConnection( @Nullable String username,  @Nullable String password) throws JMSException {
		throw new jakarta.jms.IllegalStateException(
				"SingleConnectionFactory does not support custom username and password");
	}
	...
	// Dataflow analysis limitation
	 @Nullable protected Connection getConnection() throws JMSException {
		this.connectionLock.lock();
		try {
	 ...
	 */
	 @Nullable protected Session getSession( @Nullable Connection con,  @Nullable Integer mode) throws JMSException {
		return null;
	}
	 ...
	 */
	protected void closeConnection( @Nullable Connection con) {
		if (logger.isDebugEnabled()) {
