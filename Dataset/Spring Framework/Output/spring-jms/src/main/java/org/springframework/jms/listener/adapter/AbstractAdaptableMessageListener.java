...
public abstract class AbstractAdaptableMessageListener
	...
	private Destination getResponseDestination( @Nullable Message request,  @Nullable Message response,  @Nullable Session session,  @Nullable Object result)
			throws JMSException {
	 ...
	 */
	protected Destination getResponseDestination(Message request,  @Nullable Message response,  @Nullable Session session)
			throws JMSException {
