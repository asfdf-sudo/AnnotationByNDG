...
public class MappingJackson2MessageConverter implements SmartMessageConverter, BeanClassLoaderAware {
	 ...
	 */
	// on Jackson 2.13: configure(MapperFeature, boolean)
	 ...
	 * @since 6.1
	 */
	public MappingJackson2MessageConverter( @Nullable ObjectMapper objectMapper) {
	 ...
	 * @throws IOException in case of I/O errors
	 */
	protected Message mapToMessage( @Nullable Object object,  @Nullable Session session,  @Nullable ObjectWriter objectWriter,  @Nullable MessageType targetType)
			throws JMSException, IOException {
	...
	private Class<?> extractViewClass(JsonView annotation,  @Nullable Object conversionHint) {
