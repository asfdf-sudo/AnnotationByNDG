...
public class MessagingMessageConverter implements MessageConverter, InitializingBean {
	 ...
	 * header mapper.
	 */
	public MessagingMessageConverter( @Nullable MessageConverter payloadConverter,  @Nullable JmsHeaderMapper headerMapper) {
	...
	protected jakarta.jms.Message createMessageForPayload(
			Object payload, Session session, Object conversionHint) throws JMSException {
