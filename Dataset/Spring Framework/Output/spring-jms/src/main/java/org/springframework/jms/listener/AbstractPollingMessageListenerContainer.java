...
public abstract class AbstractPollingMessageListenerContainer extends AbstractMessageListenerContainer {
	 ...
	 */
	private void rollbackOnException(PlatformTransactionManager manager, TransactionStatus status,  @Nullable Throwable ex) {
	 ...
	 */
	protected void messageReceived( @Nullable Object invoker,  @Nullable Session session) {
	}
	 ...
	 * @param session the receiving JMS Session
	 */
	protected void noMessageReceived( @Nullable Object invoker,  @Nullable Session session) {
	}
