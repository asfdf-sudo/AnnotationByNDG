...
public class UserCredentialsConnectionFactoryAdapter
	...
	protected TopicConnection doCreateTopicConnection(
			 @Nullable String username, String password) throws JMSException {
	...
	protected JMSContext doCreateContext( @Nullable String username, String password) {
		if (StringUtils.hasLength(username)) {
	...
	protected JMSContext doCreateContext( @Nullable String username, String password, int sessionMode) {
		if (StringUtils.hasLength(username)) {
			return obtainTargetConnectionFactory().createContext(username, password, sessionMode);
		}
		else {
