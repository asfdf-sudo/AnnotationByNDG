...
public class MockCallbackPreferringTransactionManager implements CallbackPreferringPlatformTransactionManager {
	...
	public TransactionStatus getStatus() {
		...
		public void commit( @Nullable TransactionStatus status) throws TransactionException {
		throw new UnsupportedOperationException();
	}

		public void rollback( @Nullable TransactionStatus status) throws TransactionException {
		throw new UnsupportedOperationException();
	}
