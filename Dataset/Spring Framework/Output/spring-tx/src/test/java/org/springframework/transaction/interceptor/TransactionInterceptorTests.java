...
class TransactionInterceptorTests extends AbstractTransactionAspectTests {
	...
	private TransactionInterceptor createTransactionInterceptor( @Nullable BeanFactory beanFactory,
			 @Nullable String transactionManagerName,  @Nullable PlatformTransactionManager transactionManager) {
