...
public abstract class AbstractReactiveTransactionManager
	...
	private GenericReactiveTransaction prepareReactiveTransaction(
			...
			Object transaction, boolean newTransaction, boolean debug, Object suspendedResources) {
	...
	private GenericReactiveTransaction newReactiveTransaction(
			TransactionSynchronizationManager synchronizationManager, TransactionDefinition definition,
			Object transaction, boolean newTransaction, boolean nested, boolean debug,
	 ...
	 * @see #doSuspend
	 */
	protected Mono<Void> doResume( @Nullable TransactionSynchronizationManager synchronizationManager,
			 @Nullable Object transaction,  @Nullable Object suspendedResources) {
