...
public class JtaTransactionManager extends AbstractPlatformTransactionManager
	 ...
	 * @param transactionManager the JTA TransactionManager to use as direct reference
	 */
	public JtaTransactionManager( @Nullable TransactionManager transactionManager) {
		this();
		Assert.notNull(transactionManager, "TransactionManager must not be null");
		this.transactionManager = transactionManager;
	 ...
	 */
	protected UserTransaction buildUserTransaction( @Nullable TransactionManager transactionManager) {
	 ...
	 * @see #setUserTransactionName
	 */
	protected UserTransaction lookupUserTransaction( @Nullable String userTransactionName)
	 ...
	 * @see #setTransactionManagerName
	 */
	protected TransactionManager lookupTransactionManager( @Nullable String transactionManagerName)
			throws TransactionSystemException {
		try {
			if (logger.isDebugEnabled()) {
	 ...
	 * @see #setTransactionSynchronizationRegistryName
	 */
	protected TransactionSynchronizationRegistry lookupTransactionSynchronizationRegistry( @Nullable String registryName) throws TransactionSystemException {
		try {
			if (logger.isDebugEnabled()) {
	 ...
	 * @throws TransactionSystemException in case of errors
	 */
	 @Nullable protected TransactionSynchronizationRegistry findTransactionSynchronizationRegistry(
