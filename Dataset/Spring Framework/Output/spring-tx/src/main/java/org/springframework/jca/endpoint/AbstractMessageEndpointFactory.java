...
public abstract class AbstractMessageEndpointFactory implements MessageEndpointFactory, BeanNameAware {
	 ...
	 */
	public void setTransactionManager( @Nullable Object transactionManager) {
	 ...
	 */
		public boolean isDeliveryTransacted( @Nullable Method method) throws NoSuchMethodException {
