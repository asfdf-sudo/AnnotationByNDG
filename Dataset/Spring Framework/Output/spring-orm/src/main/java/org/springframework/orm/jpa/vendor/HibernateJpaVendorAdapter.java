...
public class HibernateJpaVendorAdapter extends AbstractJpaVendorAdapter {
	...
	public void setPrepareConnection(boolean prepareConnection) {
		...
		public Map<String, Object> getJpaPropertyMap( @Nullable PersistenceUnitInfo pui) {
	 ...
	 */
	 @Nullable protected Class<?> determineDatabaseDialectClass( @Nullable Database database) {
	 ...
	 */
	 @Nullable protected String determineDatabaseDialectName(Database database) {
		return switch (database) {
