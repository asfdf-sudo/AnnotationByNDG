...
public class DefaultJpaDialect implements JpaDialect, Serializable {
	 ...
	 */
		 @Nullable public Object beginTransaction(EntityManager entityManager, TransactionDefinition definition)
		...
		return null;
		 ...
		 @Nullable public Object prepareTransaction( @Nullable EntityManager entityManager, boolean readOnly,  @Nullable String name)
	 ...
	 */
		 @Nullable public ConnectionHandle getJdbcConnection( @Nullable EntityManager entityManager, boolean readOnly)
