...
public class EmployeeKindConverter implements AttributeConverter<EmployeeKind, String> {
		 ...
		 @Nullable public String convertToDatabaseColumn( @Nullable EmployeeKind employeeKind) {
		...
		return null;
		 ...
		 @Nullable public EmployeeKind convertToEntityAttribute( @Nullable String data) {
		if (data != null) {
