...
public class EmployeeLocationConverter implements AttributeConverter<EmployeeLocation, String> {
		 ...
		 @Nullable public String convertToDatabaseColumn( @Nullable EmployeeLocation employeeLocation) {
		...
		return null;
		 ...
		 @Nullable public EmployeeLocation convertToEntityAttribute( @Nullable String data) {
		if (data != null) {
