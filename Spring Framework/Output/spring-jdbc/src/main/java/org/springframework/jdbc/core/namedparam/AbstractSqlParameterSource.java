...
public abstract class AbstractSqlParameterSource implements SqlParameterSource {
	 ...
	 */
	public void registerSqlType( @Nullable String paramName, int sqlType) {
	 ...
	 */
	public void registerTypeName( @Nullable String paramName,  @Nullable String typeName) {
		Assert.notNull(paramName, "Parameter name must not be null");
	 ...
	 */
		public int getSqlType( @Nullable String paramName) {
		Assert.notNull(paramName, "Parameter name must not be null");
