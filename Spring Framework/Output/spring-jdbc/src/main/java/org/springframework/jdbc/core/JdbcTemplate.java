...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
	...
	private <T extends Object> T execute(StatementCallback<T> action, boolean closeResources) throws DataAccessException {
		Assert.notNull(action, "Callback object must not be null");
	...
	private <T extends Object> T execute(PreparedStatementCreator psc, PreparedStatementCallback<T> action, boolean closeResources)
		...
		public <T extends Object> T execute(PreparedStatementCreator psc, PreparedStatementCallback<T> action)
			throws DataAccessException {
	 ...
	 */
	public <T extends Object> T query(
		...
		public <T extends Object> T query(String sql, PreparedStatementSetter pss, ResultSetExtractor<T> rse) throws DataAccessException {
		...
		return query(sql, newArgTypePreparedStatementSetter(args, argTypes), rse);
			...
			public <T extends Object> T query(String sql, Object [] args, ResultSetExtractor<T> rse) throws DataAccessException {
		return query(sql, newArgPreparedStatementSetter(args), rse);
	}

		public <T extends Object> T query(String sql, ResultSetExtractor<T> rse, Object ) throws DataAccessException {
		return query(sql, newArgPreparedStatementSetter(args), rse);
	}
		...
		public void query(String sql, RowCallbackHandler rch, Object ) throws DataAccessException {
		query(sql, newArgPreparedStatementSetter(args), rch);
	}
		...
		public <T extends Object> List<T> query(String sql, PreparedStatementSetter pss, RowMapper<T> rowMapper) throws DataAccessException {
		...
		return result(query(sql, args, argTypes, new RowMapperResultSetExtractor<>(rowMapper, 0, this.maxRows)));
			...
			public <T extends Object> List<T> query(String sql, Object [] args, RowMapper<T> rowMapper) throws DataAccessException {
		return result(query(sql, newArgPreparedStatementSetter(args), new RowMapperResultSetExtractor<>(rowMapper, 0, this.maxRows)));
	}

		public <T extends Object> List<T> query(String sql, RowMapper<T> rowMapper, Object ) throws DataAccessException {
		return result(query(sql, newArgPreparedStatementSetter(args), new RowMapperResultSetExtractor<>(rowMapper, 0, this.maxRows)));
	}
	 ...
	 * @since 5.3
	 */
	public <T extends Object> Stream<T> queryForStream(PreparedStatementCreator psc,  @Nullable PreparedStatementSetter pss,
		...
		public <T extends Object> Stream<T> queryForStream(String sql, PreparedStatementSetter pss, RowMapper<T> rowMapper) throws DataAccessException {
		return queryForStream(new SimplePreparedStatementCreator(sql), pss, rowMapper);
	}

		public <T extends Object> Stream<T> queryForStream(String sql, RowMapper<T> rowMapper, Object ) throws DataAccessException {
		return queryForStream(new SimplePreparedStatementCreator(sql), newArgPreparedStatementSetter(args), rowMapper);
	}

		public <T extends Object> T queryForObject(String sql, Object [] args, int[] argTypes, RowMapper<T> rowMapper)
			throws DataAccessException {
		...
		return DataAccessUtils.nullableSingleResult(results);
			...
			public <T extends Object> T queryForObject(String sql, Object [] args, RowMapper<T> rowMapper) throws DataAccessException {
		List<T> results = query(sql, newArgPreparedStatementSetter(args), new RowMapperResultSetExtractor<>(rowMapper, 1));
		return DataAccessUtils.nullableSingleResult(results);
	}

		public <T extends Object> T queryForObject(String sql, RowMapper<T> rowMapper, Object ) throws DataAccessException {
		List<T> results = query(sql, newArgPreparedStatementSetter(args), new RowMapperResultSetExtractor<>(rowMapper, 1));
		return DataAccessUtils.nullableSingleResult(results);
	}
		...
		public <T> T queryForObject(String sql, Class<T> requiredType, Object ) throws DataAccessException {
		return queryForObject(sql, getSingleColumnRowMapper(requiredType), args);
	}
		...
		public Map<String, Object> queryForMap(String sql, Object ) throws DataAccessException {
		...
		public <T> List<T> queryForList(String sql, Class<T> elementType, Object ) throws DataAccessException {
		return query(sql, newArgPreparedStatementSetter(args), getSingleColumnRowMapper(elementType));
	}
		...
		public List<Map<String, Object>> queryForList(String sql, Object ) throws DataAccessException {
		...
		public SqlRowSet queryForRowSet(String sql, Object ) throws DataAccessException {
	...
	protected int update(PreparedStatementCreator psc,  @Nullable PreparedStatementSetter pss)
		...
		public int update(String sql, Object ) throws DataAccessException {
	...
	//-------------------------------------------------------------------------
		...
		public <T extends Object> T execute(CallableStatementCreator csc, CallableStatementCallback<T> action)
			throws DataAccessException {
	 ...
	 * @return a Map that contains returned results
	 */
	// See https://github.com/uber/NullAway/issues/950
		...
		if (rs != null) {
			try {
				if (param.getRowMapper() != null) {
					RowMapper<? extends Object> rowMapper = param.getRowMapper();
	 ...
	 * @see SqlProvider
	 */
	 @Nullable private static String getSql( @Nullable Object obj) {
