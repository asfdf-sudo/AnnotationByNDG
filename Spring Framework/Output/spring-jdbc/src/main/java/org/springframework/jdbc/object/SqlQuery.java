 ...
 * @see SqlUpdate
 */
public abstract class SqlQuery<T extends Object> extends SqlOperation {
	 ...
	 * @since 7.0
	 */
	public Stream<T> stream(Object [] params, Map<?, ?> context) throws DataAccessException {
		validateParameters(params);
		RowMapper<T> rowMapper = newRowMapper(params, context);
	 ...
	 * @since 7.0
	 */
	public Stream<T> streamByNamedParam(Map<String, ?> paramMap, Map<?, ?> context) throws DataAccessException {
	 ...
	 */
	public List<T> executeByNamedParam(Map<String, ? extends Object> paramMap) throws DataAccessException {
	 ...
	 * @since 7.0
	 */
	public Stream<T> streamByNamedParam(Map<String, ? extends Object> paramMap) throws DataAccessException {
		return streamByNamedParam(paramMap, null);
	}

	private <R> R queryByNamedParam(Map<String, ?> paramMap, Map<?, ?> context, BiFunction<PreparedStatementCreator, RowMapper<T>, R> queryFunction) {
