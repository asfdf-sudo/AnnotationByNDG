...
public interface JdbcOperations {
	 ...
	 */
	<T extends Object> T execute(ConnectionCallback<T> action) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T execute(StatementCallback<T> action) throws DataAccessException;
	 ...
	 */
	<T extends Object> T query(String sql, ResultSetExtractor<T> rse) throws DataAccessException;
	 ...
	 */
	<T extends Object> List<T> query(String sql, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 */
	<T extends Object> Stream<T> queryForStream(String sql, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 */
	<T extends Object> T queryForObject(String sql, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T execute(PreparedStatementCreator psc, PreparedStatementCallback<T> action) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T execute(String sql, PreparedStatementCallback<T> action) throws DataAccessException;
	 ...
	 */
	<T extends Object> T query(PreparedStatementCreator psc, ResultSetExtractor<T> rse) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T query(String sql, PreparedStatementSetter pss, ResultSetExtractor<T> rse)
	 ...
	 * @see java.sql.Types
	 */
	<T extends Object> T query(String sql, Object [] args, int[] argTypes, ResultSetExtractor<T> rse) throws DataAccessException;
	 ...
	 */
		<T extends Object> T query(String sql, Object [] args, ResultSetExtractor<T> rse) throws DataAccessException;
	 ...
	 * @since 3.0.1
	 */
	<T extends Object> T query(String sql, ResultSetExtractor<T> rse, Object ) throws DataAccessException;
	 ...
	 * @since 3.0.1
	 */
	void query(String sql, RowCallbackHandler rch, Object ) throws DataAccessException;
	 ...
	 * @see PreparedStatementCreatorFactory
	 */
	<T extends Object> List<T> query(PreparedStatementCreator psc, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> List<T> query(String sql, PreparedStatementSetter pss, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @see java.sql.Types
	 */
	<T extends Object> List<T> query(String sql, Object [] args, int[] argTypes, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 */
		<T extends Object> List<T> query(String sql, Object [] args, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 * @since 3.0.1
	 */
	<T extends Object> List<T> query(String sql, RowMapper<T> rowMapper, Object ) throws DataAccessException;
	 ...
	 * @since 5.3
	 */
	<T extends Object> Stream<T> queryForStream(PreparedStatementCreator psc, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 * @since 5.3
	 */
	<T extends Object> Stream<T> queryForStream(String sql, PreparedStatementSetter pss, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 * @since 5.3
	 */
	<T extends Object> Stream<T> queryForStream(String sql, RowMapper<T> rowMapper, Object )
			throws DataAccessException;
	 ...
	 * @throws DataAccessException if the query fails
	 */
	<T extends Object> T queryForObject(String sql, Object [] args, int[] argTypes, RowMapper<T> rowMapper)
			throws DataAccessException;
	 ...
	 */
		<T extends Object> T queryForObject(String sql, Object [] args, RowMapper<T> rowMapper) throws DataAccessException;
	 ...
	 * @since 3.0.1
	 */
	<T extends Object> T queryForObject(String sql, RowMapper<T> rowMapper, Object ) throws DataAccessException;
	 ...
	 * @see #queryForObject(String, Class)
	 */
	<T> T queryForObject(String sql, Class<T> requiredType, Object ) throws DataAccessException;
	 ...
	 * @see ColumnMapRowMapper
	 */
	Map<String, Object> queryForMap(String sql, Object ) throws DataAccessException;
	 ...
	 * @see SingleColumnRowMapper
	 */
	<T> List<T> queryForList(String sql, Class<T> elementType, Object ) throws DataAccessException;
	 ...
	 * @see #queryForList(String)
	 */
	List<Map<String, Object>> queryForList(String sql, Object ) throws DataAccessException;
	 ...
	 * @see javax.sql.rowset.CachedRowSet
	 */
	SqlRowSet queryForRowSet(String sql, Object ) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem issuing the update
	 */
	int update(String sql, Object ) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T execute(CallableStatementCreator csc, CallableStatementCallback<T> action) throws DataAccessException;
	 ...
	 * @throws DataAccessException if there is any problem
	 */
	<T extends Object> T execute(String callString, CallableStatementCallback<T> action) throws DataAccessException;
