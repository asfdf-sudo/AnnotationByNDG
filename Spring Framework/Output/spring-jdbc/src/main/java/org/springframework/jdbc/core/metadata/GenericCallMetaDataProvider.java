...
public class GenericCallMetaDataProvider implements CallMetaDataProvider {
	...
	protected GenericCallMetaDataProvider(DatabaseMetaData databaseMetaData) throws SQLException {
		...
		return identifierNameToUse(schemaName);
		 ...
		 @Nullable public String metaDataCatalogNameToUse(String catalogName) {
		if (isSupportsCatalogsInProcedureCalls()) {
		 ...
		 @Nullable public String metaDataSchemaNameToUse(String schemaName) {
	...
	protected boolean isStoresLowerCaseIdentifiers() {
	 ...
	 @Nullable private String identifierNameToUse( @Nullable String identifierName) {
	 ...
	 */
	private void processProcedureColumns( @Nullable DatabaseMetaData databaseMetaData,
	...
	private ProcedureMetadata getProcedureMetadata(DatabaseMetaData databaseMetaData,
			String catalogName, String schemaName, String procedureName) throws SQLException {
		if (logger.isDebugEnabled()) {
	...
	private ProcedureMetadata getProcedureMetadataAsFunction(DatabaseMetaData databaseMetaData,
	 ...
	 @Nullable private static String escapeNamePattern( @Nullable String name,  @Nullable String escape) {
	...
	private record ProcedureMetadata(String schemaName, String procedureName,
