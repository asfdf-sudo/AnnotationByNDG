...
class ScriptUtilsTests {
	...
	void readAndSplitScriptContainingMultiLineComments() throws Exception {
		...
		assertThat(statements).containsExactly(statement1, statement2);
			...
			void containsStatementSeparator( @Nullable String script,  @Nullable String delimiter, boolean expected) {
	...
	private static void splitSqlScript(EncodedResource resource, String script,
