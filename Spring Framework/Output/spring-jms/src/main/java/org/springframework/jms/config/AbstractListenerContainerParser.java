...
abstract class AbstractListenerContainerParser implements BeanDefinitionParser {
	 ...
	 */
	protected abstract MutablePropertyValues parseSpecificContainerProperties( @Nullable Element containerEle,  @Nullable ParserContext parserContext);
	 ...
	 */
	protected abstract RootBeanDefinition createContainer( @Nullable Element containerEle,  @Nullable Element listenerEle,  @Nullable ParserContext parserContext,
			 @Nullable PropertyValues commonContainerProperties,  @Nullable PropertyValues specificContainerProperties);


	 @Nullable protected Integer parseAcknowledgeMode(Element ele, ParserContext parserContext) {
