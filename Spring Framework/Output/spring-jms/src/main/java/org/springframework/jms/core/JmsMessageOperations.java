...
public interface JmsMessageOperations extends MessageSendingOperations<Destination>,
	 ...
	 * @since 7.0
	 */
	Message<?> receiveSelected(String messageSelector) throws MessagingException;
	 ...
	 * @since 7.0
	 */
	<T> T receiveSelectedAndConvert(String messageSelector, Class<T> targetClass)
			throws MessagingException;
	 ...
	 * @since 7.0
	 */
	<T> T receiveSelectedAndConvert(Destination destination, String messageSelector,
	 ...
	 * @since 7.0
	 */
	<T> T receiveSelectedAndConvert(String destinationName, String messageSelector,
			Class<T> targetClass) throws MessagingException;
