...
public class JmsResponse<T> {
	 ...
	 */
	protected JmsResponse(T response,  @Nullable Object destination) {
	 ...
	 */
	 @Nullable public Destination resolveDestination(DestinationResolver destinationResolver, Session session)
			throws JMSException {
