...
public interface JmsOperations {
	 ...
	 * @since 7.0.4
	 */
	Message sendAndReceive(Destination destination, Destination responseQueue, MessageCreator messageCreator)
			throws JmsException;
	 ...
	 * @since 7.0.4
	 */
	Message sendAndReceive(String destinationName, String responseQueueName, MessageCreator messageCreator)
			throws JmsException;
