...
public abstract class AbstractJmsListenerContainerFactory<C extends AbstractMessageListenerContainer>
	 ...
	 */
	public void setReplyPubSubDomain( @Nullable Boolean replyPubSubDomain) {
	 ...
	 */
	public void setSubscriptionDurable( @Nullable Boolean subscriptionDurable) {
	 ...
	 */
	public void setSubscriptionShared( @Nullable Boolean subscriptionShared) {
