...
public class JmsTemplate extends JmsDestinationAccessor implements JmsOperations {
	 ...
	 */
	 ...
	 @Nullable private Queue getDefaultQueue() {
	 ...
	 */
	protected void doSend( @Nullable Session session,  @Nullable Destination destination, MessageCreator messageCreator)
			throws JMSException {
	...
	//---------------------------------------------------------------------------------------
		...
		public void convertAndSend( @Nullable Object message,  @Nullable MessagePostProcessor postProcessor) throws JmsException {
		Destination defaultDestination = getDefaultDestination();
		if (defaultDestination != null) {
	...
	//---------------------------------------------------------------------------------------
		...
		public Message sendAndReceive(Destination destination, Destination responseQueue, MessageCreator messageCreator) throws JmsException {
		...
		public Message sendAndReceive(String destinationName, String responseQueueName, MessageCreator messageCreator) throws JmsException {
		return executeLocal(session -> {
			Destination destination = resolveDestinationName(session, destinationName);
	 ...
	 * @throws JMSException if thrown by JMS API methods
	 */
	protected Message doSendAndReceive(Session session, Destination destination, Destination responseQueue,  @Nullable MessageCreator messageCreator)
			throws JMSException {
	...
	//---------------------------------------------------------------------------------------
		...
		public <T> T browseSelected( @Nullable Queue queue,  @Nullable String messageSelector, BrowserCallback<T> action)
			throws JmsException {
