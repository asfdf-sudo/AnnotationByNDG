...
public abstract class AbstractTransactionStatus implements TransactionStatus {
	 ...
	 */
		public void rollbackToSavepoint( @Nullable Object savepoint) throws TransactionException {
		TransactionSynchronizationUtils.triggerSavepointRollback(savepoint);
		getSavepointManager().rollbackToSavepoint(savepoint);
	}
	 ...
	 */
		public void releaseSavepoint( @Nullable Object savepoint) throws TransactionException {
		getSavepointManager().releaseSavepoint(savepoint);
	}
