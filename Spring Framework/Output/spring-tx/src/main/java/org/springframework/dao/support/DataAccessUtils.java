...
public abstract class DataAccessUtils {
	 ...
	 * @since 6.1
	 */
	public static <T> Optional<T> optionalResult(Collection<? extends T> results)
	 ...
	 * @since 6.1
	 */
	public static <T> Optional<T> optionalResult(Stream<T> results) throws IncorrectResultSizeDataAccessException {
		return Optional.ofNullable(singleResult(results));
	}
	 ...
	 * @since 6.1
	 */
	public static <T> Optional<T> optionalResult(Iterator<T> results) throws IncorrectResultSizeDataAccessException {
		return Optional.ofNullable(singleResult(results));
	}
	 ...
	 */
	public static <T extends Object> T requiredSingleResult(Collection<T> results)
			throws IncorrectResultSizeDataAccessException {
	 ...
	 * @since 5.0.2
	 */
	public static <T extends Object> T nullableSingleResult(Collection<T> results)
			throws IncorrectResultSizeDataAccessException {
	 ...
	 */
		public static <T> T objectResult(Collection<?> results,  @Nullable Class<T> requiredType)
	...
	public static RuntimeException translateIfNecessary(
			 @Nullable RuntimeException rawException, PersistenceExceptionTranslator pet) {
