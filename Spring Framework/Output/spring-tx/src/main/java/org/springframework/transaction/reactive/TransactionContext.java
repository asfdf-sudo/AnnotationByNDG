...
public class TransactionContext {
	...
	TransactionContext(TransactionContext parent) {
		this.parent = parent;
	}
	...
	public void setSynchronizations(Set<TransactionSynchronization> synchronizations) {
	...
	public void setCurrentTransactionName(String currentTransactionName) {
	...
	public void setCurrentTransactionIsolationLevel(Integer currentTransactionIsolationLevel) {
