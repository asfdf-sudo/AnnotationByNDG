...
public abstract class AbstractPlatformTransactionManager
	 ...
	 */
	private TransactionStatus startTransaction( @Nullable TransactionDefinition definition,  @Nullable Object transaction,
	 ...
	 * @see #resume
	 */
	 @Nullable protected final SuspendedResourcesHolder suspend( @Nullable Object transaction) throws TransactionException {
	 ...
	 * @see #doSuspend
	 */
	protected void doResume( @Nullable Object transaction,  @Nullable Object suspendedResources) throws TransactionException {
		throw new TransactionSuspensionNotSupportedException(
				"Transaction manager [" + getClass().getName() + "] does not support transaction suspension");
	}
