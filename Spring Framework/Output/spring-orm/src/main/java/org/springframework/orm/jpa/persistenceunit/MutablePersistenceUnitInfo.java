...
public class MutablePersistenceUnitInfo {
	...
	public void addMappingFileName( @Nullable String mappingFileName) {
	...
	public void addJarFileUrl( @Nullable URL jarFileUrl) {
	...
	public void setValidationMode( @Nullable ValidationMode validationMode) {
