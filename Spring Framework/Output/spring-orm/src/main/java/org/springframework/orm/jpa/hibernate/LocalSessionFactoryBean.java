...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
	 ...
	 * @see #setDataSource
	 */
	public void setHibernateProperties( @Nullable Properties hibernateProperties) {
	 ...
	 */
	 @Nullable public MetadataSources getMetadataSources() {
		this.metadataSourcesAccessed = true;
	 ...
	 */
		public <S> S getObject(Class<S> type) throws Exception {
