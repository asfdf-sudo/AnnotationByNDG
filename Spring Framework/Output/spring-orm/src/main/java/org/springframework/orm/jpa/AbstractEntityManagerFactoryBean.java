...
public abstract class AbstractEntityManagerFactoryBean implements
	 ...
	 */
	 @Nullable Object invokeProxyMethod(Method method,  @Nullable Object [] args) throws Throwable {
	 ...
	 */
		public DataAccessException translateExceptionIfPossible( @Nullable RuntimeException ex) {
	 ...
	 */
		 @Nullable public <S> S getObject(Class<S> type) throws Exception {
	...
	private void readObject( @Nullable ObjectInputStream ois) throws IOException, ClassNotFoundException {
