...
public class DefaultPersistenceUnitManager
	 ...
	 */
	public void setDefaultPersistenceUnitName( @Nullable String defaultPersistenceUnitName) {
	 ...
	 * @since 7.0
	 */
	public void setPersistenceConfiguration( @Nullable PersistenceConfiguration configuration) {
	 ...
	 */
	public void setPersistenceUnitPostProcessors(PersistenceUnitPostProcessor ) {
	 ...
	 */
	 @Nullable private URL determineDefaultPersistenceUnitRootUrl() {
	...
	protected boolean isPersistenceUnitOverrideAllowed() {
		...
		public PersistenceUnitInfo obtainPersistenceUnitInfo( @Nullable String persistenceUnitName) {
