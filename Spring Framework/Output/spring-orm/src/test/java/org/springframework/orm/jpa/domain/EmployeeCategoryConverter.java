...
public class EmployeeCategoryConverter implements AttributeConverter<EmployeeCategory, String> {
		 ...
		 @Nullable public String convertToDatabaseColumn( @Nullable EmployeeCategory employeeCategory) {
		...
		return null;
		 ...
		 @Nullable public EmployeeCategory convertToEntityAttribute( @Nullable String data) {
		if (data != null) {
