...
# Approaches Overview
- NDG : which synergizes the deterministic nature of static code parsing with the powerful semantic reasoning capabilities of LLMs to capture complex inter-procedural data flows that traditional analysis combinations often miss. Running script `test_npe_run_new.py`
